...
data_dir = '/scratch/summit/elcu4811/burn.preprocess'
burn_out_fn = os.path.join(data_dir, 'out/slide_modisburndate_ne.csv')
slide_fn = os.path.join(data_dir, 'data/SLIDE_NASA_GLC/GLC20180821.csv')
burn_fn = os.path.join(data_dir, 'out/netcdf/MCD64A1.*.ne.*.nc')
